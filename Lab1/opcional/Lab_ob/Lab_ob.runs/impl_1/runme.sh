...
HD_PWD='/home/ebrahim/vivado/Lab1/opcional1/Lab_ob/Lab_ob.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_ob_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1_ob_wrapper.tcl -notrace
