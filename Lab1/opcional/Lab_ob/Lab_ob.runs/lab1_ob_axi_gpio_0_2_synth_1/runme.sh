...
HD_PWD='/home/ebrahim/vivado/Lab1/opcional1/Lab_ob/Lab_ob.runs/lab1_ob_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_ob_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_ob_axi_gpio_0_2.tcl
