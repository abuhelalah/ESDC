...
HD_PWD='/home/ebrahim/vivado/Lab1/Lab1_sf/Lab1_sf.runs/Lab1_sf_xlslice_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_sf_xlslice_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_sf_xlslice_0_1.tcl
