...
HD_PWD='/home/ebrahim/vivado/Lab1/mixed_approach/mixed_approach.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_sf_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_sf_wrapper.tcl -notrace
