...
HD_PWD='/home/ebrahim/vivado/Lab1/mixed_approach/mixed_approach.runs/Lab1_sf_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_sf_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_sf_xlconstant_0_0.tcl
