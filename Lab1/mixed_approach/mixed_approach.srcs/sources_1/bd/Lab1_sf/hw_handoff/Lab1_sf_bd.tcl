...
proc create_root_design { parentCell } {
  ...
  # Create instance: COMPARATOR, and set properties
  set COMPARATOR [ create_bd_cell -type ip -vlnv user.org:user:screen_object:1.0 COMPARATOR ]

  # Create instance: ROW_POSITION, and set properties
  set ROW_POSITION [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 ROW_POSITION ]
...
CONFIG.C_GPIO_WIDTH {4} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins xpos/S_AXI]

  # Create port connections
  connect_bd_net -net ROW_POSITION_dout [get_bd_pins COMPARATOR/cy] [get_bd_pins ROW_POSITION/dout]
  connect_bd_net -net VGA_SYNC_0_pixel_column [get_bd_pins COMPARATOR/pixel_column] [get_bd_pins VGA_SYNC_0/pixel_column]
  connect_bd_net -net VGA_SYNC_0_pixel_row [get_bd_pins COMPARATOR/pixel_row] [get_bd_pins VGA_SYNC_0/pixel_row]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins buttons/s_axi_aclk] [get_bd_pins leds/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xpos/s_axi_aclk]
  ...
  connect_bd_net -net readRow1_gpio_io_o [get_bd_pins COMPARATOR/cx] [get_bd_pins xpos/gpio_io_o]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins buttons/s_axi_aresetn] [get_bd_pins leds/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xpos/s_axi_aresetn]
  connect_bd_net -net screen_object_0_pixel_color [get_bd_pins COMPARATOR/pixel_color] [get_bd_pins VGA_SYNC_0/color_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xpos/S_AXI/Reg] SEG_xpos_Reg
